...
The retained legacy implementation is in `processing/legacy_face_tools/process_image_baseline_face_features.py`. It uses OpenCV for video input, annotation, and output, and MediaPipe Face Landmarker for single-face tracking and landmark estimation.
...
`derived/P01/Image_Experiment/legacy_outputs/analysis_outputs/`
